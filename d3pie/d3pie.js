...
var helpers = {
	...
	textWrap: function(text, width, paddingRightLeft, paddingTopBottom) {
	    ...
	    text.each(function() {
	        ...
	        //if inner labels we use the x position
	        var tclass = d3.select(text.node().parentNode).attr('class');
	        if (tclass) {
	            switch (textAlign) {
	                case 'start':
	                    x = paddingRightLeft;
